...
namespace CapaDatos.Interfaz.RegistroFormulario.Interface
{
    public interface IRegistroFormularioCapaDatos
    {
       ...
       void GuardaPeticionRespuestaErp(PeticionRespuestaERPDTO objRegistro);
        ...
        Task<bool> ValidaResultadosListas(int IdFormulario);
        ...
        void GuardaPeticionRespuestaFirma(PeticionRespuestaFirmaNetco objRegistro);

         Task<DataTable> DevuleveUIDOcumento(int IdFormualrio);


        void ActualizaPeticionRespuestaFirma(int Id, int idformulaio);
